...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.hobby'
        db.add_column(u'candidate_candidate', 'hobby',
                      self.gf('django.db.models.fields.CharField')(max_length='100', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate.hobby'
        db.delete_column(u'candidate_candidate', 'hobby')
    ...
    models = {
        u'candidate.candidate': {
            ...
            'hobby': ('django.db.models.fields.CharField', [], {'max_length': "'100'", 'null': 'True', 'blank': 'True'}),
